...
- Set a proper name for your article — it'll be the same as the filename, except with all underscores (`_`) swapped to spaces (` `).
  - You can also add the file to a subfolder with a tilde at the beginning 
...
This might be a doosie, however here are clarifications on the layout of the project to help you get started:
...
<table>
  <tr>
    ...
    <td>Smaller features and entire page theme</td>
  </tr>
  <tr>
    <td>
...
Any code additions or changes that don't have
- Very careless vibecoding
- Minified-esque format
